    ...
    items: [
        {
            ...
            img: psale1,
            price: "200",
            color: "to right top, #e50c61, #e70e62, #e80f64, #ea1165, #eb1267",
            shadow: "#e50c61",
        },
        {
            id: "0p0x1",
            ...
            img: psale2,
            price: "200",
            color: "to right top, #0c63e5, #0769e7, #076fe8, #0b74ea, #127aeb",
            shadow: "#0c63e5",
        },
        {
            id: "0p0x3",
            ...
            img: psale3,
            price: "200",
            color: "to right top, #e50cd2, #e00ad8, #db0ade, #d50de5, #ce12eb",
            shadow: "#e50cd2",
        }
    ],
};
...
const toprateslaes = {
    ...
    items: [{
            ...
            img: product7,
            price: "150",
            color: "153deg, rgba(37,37,255,1) 0%, rgba(0,176,255,1) 100%",
            shadow: "rgba(37,37,255,0.8)",
        },
        {
            id: "0M0x2",
            ...
            img: product2,
            price: "150",
            color: "153deg, rgba(37,255,51,1) 0%, rgba(0,255,128,1) 100%",
            shadow: "rgba(37,255,51,0.8)",
        },
        {
            id: "0M0x3",
            ...
            img: product3,
            price: "150",
            color: "153deg, rgba(255,55,37,1) 0%, rgba(255,81,0,1) 100%",
            shadow: "rgba(255,55,37,0.8)",
        },
        {
            id: "0M0x4",
            ...
            img: product4,
            price: "150",
            color: "153deg, rgba(255,132,37,1) 0%, rgba(255,171,0,1) 100%",
            shadow: "rgba(255,132,37,0.8)",
        },
        {
            id: "0M0x5",
            ...
            img: product5,
            price: "150",
            color: "153deg, rgba(126,83,60,1) 0%, rgba(242,203,21,1) 100%",
            shadow: "rgba(126,83,60,0.8)",
        },
        {
            id: "0M0x6",
            ...
            img: product6,
            price: "150",
            color: "153deg, rgba(17,176,231,1) 0%, rgba(21,226,242,1) 100%",
            shadow: "rgba(17,176,231,0.8)",
        },
        {
            id: "0M0x7",
            ...
            img: product1,
            price: "150",
            color: "153deg, rgba(231,218,17,1) 0%, rgba(215,242,21,1) 100%",
            shadow: "rgba(231,218,17,0.8)",
        },
        {
            id: "0M0x8",
            ...
            img: product9,
            price: "150",
            color: "153deg, rgba(128,123,59,1) 0%, rgba(90,101,15,1) 100%",
            shadow: "rgba(128,123,59,0.8)",
        },
        {
            id: "0M0x9",
            ...
            img: product10,
            price: "150",
            color: "153deg, rgba(41,96,136,1) 0%, rgba(13,121,195,1) 100%",
            shadow: "rgba(41,96,136,0.8)",
        },
        {
            id: "0M0x10",
            ...
            img: product12,
            price: "150",
            color: "153deg, rgba(48,189,19,1) 0%, rgba(20,209,51,1",
            shadow: "rgba(48,189,19,0.8)",
        },
        {
            id: "0M0x11",
            ...
            img: product11,
            price: "150",
            color: "153deg, rgba(25,41,21,1) 0%, rgba(13,32,16,1) 100%",
            shadow: "rgba(25,41,21,0.8)",
        },
        {
            id: "0M0x12",
            title: "Nike Zoom Max",
            ...
            img: product8,
            price: "150",
            color: "153deg, rgba(16,84,226,1) 0%, rgba(26,63,89,1) 100%",
            shadow: "rgba(16,84,226,0.8)",
        },
    ],
};
